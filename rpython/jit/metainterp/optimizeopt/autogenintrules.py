...
from rpython.rlib.rarithmetic import r_uint, intmask, ovfcheck, uint_mul_high, highest_bit
from rpython.jit.metainterp.optimizeopt import intutils as _intutils
# Use target-aware values (updated for cross-compilation by
# intutils._update_for_target_long_bit before annotation starts)
MAXINT = _intutils.MAXINT
MININT = _intutils.MININT
LONG_BIT = _intutils.LONG_BIT


def _update_for_target_long_bit():
    """Re-read target-aware constants from intutils after cross-compilation
    update.  Called from translationoption.set_opt_level()."""
    global MAXINT, MININT, LONG_BIT
    MAXINT = _intutils.MAXINT
    MININT = _intutils.MININT
    LONG_BIT = _intutils.LONG_BIT
